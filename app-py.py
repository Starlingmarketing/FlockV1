...
def drafts_setup():
    return render_template('drafts/setup.html')

@app.route('/drafts/ai-settings')
def drafts_ai_settings():
    return render_template('drafts/ai_settings.html')

@app.route('/drafts/manual')
def drafts_manual():
    return render_template('drafts/manual.html')

@app.route('/drafts/automation')
def drafts_automation():
    return render_template('drafts/automation.html')
...
def sending_setup():
    return render_template('sending/setup.html')

@app.route('/sending/automation')
def sending_automation():
    return render_template('sending/automation.html')
...
def test_perplexity():
    ...
    # Use the perplexity_service to test the connection (simplified for example)
    try:
        # This would be implemented with actual API calls
        # Using a placeholder response for the example
        response = {
            'success': True,
